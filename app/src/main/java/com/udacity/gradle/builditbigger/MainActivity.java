...
import com.example.kathy.myapplication.backend.myEndpoint.MyEndpoint;
import com.example.mylibrary.DisplayActivity;
...
public class MainActivity extends ActionBarActivity {
    ...
    class EndpointsAsyncTask extends AsyncTask<Void, Void, String> {
        private MyEndpoint myApiService = null;
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                return myApiService.getJokeFromEndPoint().execute().getJoke();
            } catch (IOException e) {
                return e.getMessage();
            }
        }
